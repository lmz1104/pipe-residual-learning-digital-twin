...
This repository presents a simplified research-oriented prototype for thermo-fluid pipeline digital twin modeling.

The framework combines:

* mechanistic thermo-fluid modeling,
* synthetic observation generation,
* residual learning correction (Linear Regression / Random Forest),
* vibration proxy modeling,
...
* introducing real industrial pipeline datasets,
* adding physics-constrained learning objectives,
* extending to transient thermo-fluid coupling,
* incorporating uncertainty quantification,
* and exploring PINN-based correction frameworks.
